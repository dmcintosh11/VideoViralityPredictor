...
async def get_related_videos(input_video_url: str, df: pd.DataFrame, count: int=5):
...
def get_related_videos_from_df(df):
    ...
    for i, url in enumerate(url_list):
        ...
        df = asyncio.run(get_related_videos(url, df))
...
#Just used this for first run to create csv
